...
$skype = get_option(SHORT_NAME . "_skype");
$info_email = get_option('admin_email');
?>
<!DOCTYPE html>
...
<head>
    ...
    <script>
        ...
        var no_image_src = themeUrl + "/images/no_image_available.png";
        var ajaxurl = '<?php echo admin_url('admin-ajax.php') ?>';
        var lang = "<?php echo getLocale(); ?>";
        var fan_page_url='<?php echo $fbURL; ?>';
    </script>
            ...
            <div class="title">
                ...
                ?>
                    <a title="<?php bloginfo("name"); ?>" href="<?php echo home_url(); ?>">
                        <img src="<?php echo get_option("mobilelogo"); ?>" alt="<?php echo get_option(SHORT_NAME . "_hotline"); ?>" />
                    </a>
                <?php
                } else {
                ?>
                    <p class="proxima"><a title="<?php bloginfo("name"); ?>" href="<?php echo home_url(); ?>">
        ...
        <div class="tophead">
            <div class="container">
                <ul class="social_bookmarks">
                    <?php if (!empty($fbURL)): ?>
                    <li class="social_bookmarks_facebook"><a target="_blank" href="<?php echo $fbURL ?>" title="Facebook"></a></li>
                    <?php endif; ?>
                    <?php if (!empty($googlePlusURL)): ?>
                    <li class="social_bookmarks_gplus"><a target="_blank" href="<?php echo $googlePlusURL ?>" title="Google plus"></a></li>
                    <?php endif; ?>
                    <?php if (!empty($twitterURL)): ?>
                    <li class="social_bookmarks_twitter"><a target="_blank" href="<?php echo $twitterURL ?>" title="Twitter"></a></li>
                    <?php endif; ?>
                    <?php if (!empty($skype)): ?>
                    <li class="social_bookmarks_skype"><a href="skype:<?php echo $skype ?>?chat" title="Skype"></a></li>
                    <?php endif; ?>
                    <?php if (!empty($info_email)): ?>
                    <li class="social_bookmarks_mail"><a href="mailto:<?php echo $info_email ?>" title="Mail"></a></li>
                    <?php endif; ?>
                </ul>
                <div class="sologan"><?php echo bloginfo("description"); ?></div>
