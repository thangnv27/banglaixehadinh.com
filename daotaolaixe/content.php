...
?>
    <div class="col-xs-12 col-sm-4 col-md-4 mb30" itemscope="" itemtype="http://schema.org/Article">
        <a href="<?php the_permalink(); ?>" onclick="_gaq.push(['_trackEvent', 'Xem tin', 'Xem tin', '<?php the_title(); ?>']);">
            <img src="<?php the_post_thumbnail_url('260x130'); ?>" style="width:100%; max-width:100%;" alt="<?php the_title(); ?>" itemprop="image" onerror="this.src=no_image_src" />
        </a>
        <div style="height: 60px" class="mt10 t_center itemTitle" itemprop="name">
            <a href="<?php the_permalink(); ?>" itemprop="url" onclick="_gaq.push(['_trackEvent', 'Xem tin', 'Xem tin', '<?php the_title(); ?>']);"><?php the_title(); ?></a>
        </div>
        <div class="mt5 t_center itemDate">
        ...
        <div class="mt5 itemTag t_center">
            <span class="keyword" itemprop="keywords"><a href="<?php echo get_tag_link($posttags[0]->term_id) ?>" onclick="_gaq.push(['_trackEvent', 'Xem theo tag', 'Xem theo tag', '<?php echo $posttags[0]->name ?>']);"><?php echo $posttags[0]->name ?></a></span>
        </div>
    </div>
<?php endif; ?>